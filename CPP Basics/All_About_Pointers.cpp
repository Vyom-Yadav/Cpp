...
int main(){
    ...
    *ptr = 20;
    cout<<a<<" "<<*ptr<<endl; */
    // Double pointer
    int **ptr1; // Dont relate star logic from here, it used when we apply after declaration.
    ptr1 = &ptr;
    ...
    cout<<"The value stored in double pointer can also be called like: "<<*(&ptr1)<<endl;
